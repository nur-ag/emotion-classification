...
CLASSIC_BATCH_SIZE = 500000
CLASSIC_EXTRACTOR_TYPES = ['bow', 'tfidf']
BERT_BATCH_SIZE = 64
FASTTEXT_BATCH_SIZE = 2048

CONFIG_ROOT = 'configs/Vent/large-grid/'
CLASSIC_OUTPUT_PATH = 'output/Vent/large-grid/classic/'
NEURAL_OUTPUT_PATH = 'output/Vent/large-grid/neural/'

DATA_CONFIG = DataConfig(raw_path='preprocessed/vent-robust-splits.parquet', 
                         cache_path='preprocessed/vent-split-robust-cache/', 
...
DNN_HIDDEN_SIZES = [100, 200]
DNN_NUM_LAYERS = [3, 5]
DNN_NUM_EPOCHS = [1, 2, 3]
...
TFIDF_NUM_WORDS = [20000, 40000, 80000]

NB_SMOOTHING = [0.1, 0.01]
SGD_NUM_EPOCHS = [1, 2]
SGD_ALPHA = [0.0001]

RF_TREES_PER_BATCH = [125, 250, 500]
RF_MAX_DEPTH = [4, 5]
RF_MAX_FEATURES = [0.1]
