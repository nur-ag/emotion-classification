...
CONFIG_ROOT = 'configs/Vent/'
CLASSIC_OUTPUT_PATH = 'output/Vent/classic/'
NEURAL_OUTPUT_PATH = 'output/Vent/neural/'

DATA_CONFIG = DataConfig(raw_path='preprocessed/vent-robust-equivalent-sample.parquet', 
